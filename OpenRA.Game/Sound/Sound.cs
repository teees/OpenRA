		...
		ISoundSource LoadSound(string filename)
		{
			...
			foreach (var loader in Game.ModData.SoundLoaders)
			{
				...
				if (loader.TryParseSound(stream, out soundFormat))
					return soundEngine.AddSoundSourceFromStream(soundFormat.GetPCMInputStream(), soundFormat.Channels, soundFormat.SampleBits, soundFormat.SampleRate);
			}
